    ...
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid w-full gap-8 lg:grid-cols-[1.15fr_0.85fr]">
          <section className="rounded-[2rem] border border-emerald-100/80 bg-white/94 p-8 shadow-[0_25px_90px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-10">
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-emerald-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-950">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                id="cta-admin-login"
                href="/admin"
                className="inline-flex items-center justify-center rounded-xl border border-emerald-200 bg-white px-5 py-3 text-sm font-semibold text-emerald-950 transition hover:border-emerald-300 hover:bg-emerald-50"
              >
                Admin Dashboard
              </Link>
            </div>
