...
export default function DevParentPage() {
  return (
    ...
    >
      <div className="mb-6 rounded-3xl border border-slate-200 bg-white p-6 text-slate-900 shadow-sm">
          ...
          <div key={app.id} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <h3 className="mt-1 text-lg font-semibold text-slate-900">{app.learnerName}</h3>
