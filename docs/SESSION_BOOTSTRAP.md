...
For a fresh start or a relay from another platform, read [SESSION_MANIFEST.md](./SESSION_MANIFEST.md) first, then use this checklist to confirm the workspace is actually ready.
