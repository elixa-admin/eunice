...
export function getReadinessChecklist(input: ApplicationRequirementInput = {}) {
  return getApplicationDocumentRequirements(input).map((requirement) => requirement.label);
}
