...
const featureTiles = [
  ...
  'Clear status and upload recovery',
];
    ...
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-7xl items-center px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid w-full gap-8 lg:grid-cols-[1.08fr_0.92fr]">
          <section className="rounded-[2.25rem] border border-emerald-100/80 bg-white/94 p-8 shadow-[0_25px_90px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-10">
            ...
            <h1 className="display-serif mt-6 max-w-2xl text-4xl font-semibold tracking-tight text-slate-950 sm:text-5xl lg:text-6xl">
          ...
          <aside className="space-y-4 rounded-[2rem] border border-slate-200/80 bg-slate-950 p-8 text-white shadow-[0_25px_90px_rgba(15,23,42,0.18)]">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
                <div className="text-sm font-semibold text-white">What we are polishing</div>
                <div className="mt-1 text-sm leading-6 text-slate-300">
