...
import {
  ...
  ADMIN_DOCUMENT_CATEGORY_ORDER,
  ADMIN_DOCUMENT_REQUIREMENTS,
  MiniSparkline,
  TRIAGE_FILTERS,
  TRIAGE_LANE_LABELS,
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="mt-4 grid gap-3 sm:grid-cols-2">
              <div className={`${SUBTLE_PANEL_CLASS_NAME} p-4`}>
                ...
                <p className="mt-2 text-[11px] font-medium text-emerald-300/80">Verified docs {dossierAccuracy}%</p>
              </div>
              <div className={`${SUBTLE_PANEL_CLASS_NAME} p-4`}>
          ...
          <div className={`${SURFACE_CARD_CLASS_NAME} rounded-[2rem] border border-emerald-500/10 bg-emerald-950/20 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.28)] backdrop-blur-xl`}>
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              <div className={`${SUBTLE_PANEL_CLASS_NAME} p-4`}>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-300">Move blockers first to keep the queue moving.</p>
              </div>
              <div className={`${SUBTLE_PANEL_CLASS_NAME} p-4`}>
                ...
                <p className="mt-1 text-sm leading-6 text-slate-300">Compared with the previous 7 days.</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between border-b border-white/10 px-6 py-4">
              <div>
                ...
                <h3 className="text-base font-bold text-white mt-0.5">
                  {DOCUMENT_TYPE_LABELS[previewDoc.document_type] || previewDoc.document_type}
                </h3>
              </div>
